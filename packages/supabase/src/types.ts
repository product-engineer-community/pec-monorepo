import { User, Post, Comment, Like, Event } from "@pec/shared";
  ...
  public: {
    Tables: {
      ...
      comments: {
        ...
        >;
        Update: Partial<
          Omit<Comment, "id" | "created_at" | "updated_at" | "likes_count">
        >;
      };
      likes: {
        Row: Like;
      ...
      events: {
        ...
        >;
        Update: Partial<
          Omit<Event, "id" | "created_at" | "updated_at" | "attendees_count">
        >;
      };
    };
  };
